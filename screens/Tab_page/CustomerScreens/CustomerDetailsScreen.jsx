...
const getData = async () => {
    ...
    const getUrl = `https://khataapp-backend.vercel.app/api/customers/${customerId}`; // Replace with your actual API endpoint
...
useFocusEffect(
  ...
  const deleteData = async () => {
    ...
    const deleteUrl = `https://khataapp-backend.vercel.app/api/customers/${customerId}`; // Replace with your actual API endpoint
